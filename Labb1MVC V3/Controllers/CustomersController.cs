...
namespace Labb1MVC_V3.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,CustomerFName,CustomerLName")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,CustomerFName,CustomerLName,CustomerEmail")] Customer customer)
        {
